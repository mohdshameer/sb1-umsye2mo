...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden cursor-none">
      ...
      <nav className={`fixed top-0 w-full z-40 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="text-2xl font-bold text-white interactive">
            ...
            <div className="hidden md:flex space-x-8">
              {['Home', 'About', 'Skills', 'Services', 'Projects', 'Contact'].map((item) => (
                <button
                  ...
                  className={`text-sm font-medium transition-all duration-300 hover:text-cyan-400 interactive relative ${
                    activeSection === item.toLowerCase() ? 'text-cyan-400' : 'text-gray-300'
                  }`}
                >
                  {item}
                  {activeSection === item.toLowerCase() && (
                    <div className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-cyan-400 to-blue-500 animate-pulse"></div>
                  )}
                </button>
              ))}
            </div>
            ...
            <div className="md:hidden pb-4 animate-fade-in">
              {['Home', 'About', 'Skills', 'Services', 'Projects', 'Contact'].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollToSection(item.toLowerCase())}
                  className="block w-full text-left px-4 py-2 text-gray-300 hover:text-cyan-400 transition-colors interactive"
                >
                  {item}
                </button>
              ))}
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto animate-fade-in delay-600">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 animate-fade-in delay-1000">
              {[
                ...
                <div key={index} className="text-center group">
                  <div className="p-4 bg-gradient-to-r from-gray-800/50 to-gray-900/50 rounded-xl backdrop-blur-sm border border-gray-700/50 group-hover:border-cyan-500/50 transition-all duration-300 interactive">
      ...
      {/* About Section */}
      <section id="about" className="py-20 bg-gradient-to-b from-gray-900/50 to-black relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative animate-slide-in-right">
              <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 rounded-2xl p-8 backdrop-blur-sm border border-cyan-500/30 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={index} className="text-center group">
                      ...
                      <div className="text-3xl font-bold text-cyan-300 group-hover:scale-110 transition-transform duration-300">{stat.number}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skills.map((skill, index) => (
              <Card key={index} className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 hover:border-cyan-500/50 transition-all duration-500 backdrop-blur-sm interactive group animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 hover:border-cyan-500/50 transition-all duration-500 backdrop-blur-sm interactive group animate-fade-in-up" style={{ animationDelay: `${index * 150}ms` }}>
                <CardHeader>
                  <div className="flex items-center gap-4 mb-4">
                    <div className={`p-4 bg-gradient-to-r ${service.gradient} rounded-xl group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                ...
                <CardContent>
                  <ul className="space-y-3">
                    {service.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center gap-3 text-gray-300 group-hover:text-white transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project, index) => (
              <Card key={index} className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 hover:border-cyan-500/50 transition-all duration-500 backdrop-blur-sm interactive group animate-fade-in-up overflow-hidden" style={{ animationDelay: `${index * 100}ms` }}>
                ...
                <CardHeader>
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <ExternalLink className="text-gray-400 group-hover:text-cyan-400 transition-colors duration-300 interactive" size={20} />
                  </div>
                  <CardTitle className="text-white text-xl mb-2 group-hover:text-cyan-400 transition-colors duration-300">{project.title}</CardTitle>
                ...
                <CardContent>
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, techIndex) => (
                      <Badge key={techIndex} variant="outline" className="border-gray-600 text-gray-300 hover:border-cyan-400 hover:text-cyan-400 transition-colors duration-300 interactive">
                        {tech}
                      </Badge>
                    ))}
                  </div>
      ...
      <section id="contact" className="py-20 bg-gradient-to-b from-gray-900/50 to-black relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="animate-slide-in-left">
              <h3 className="text-3xl font-semibold text-white mb-6">Let's Discuss Your Project</h3>
              <p className="text-gray-300 mb-8 text-lg leading-relaxed">
              ...
              <div className="flex gap-4 mt-8">
                {[
                  ...
                  <Button key={index} size="sm" variant="outline" className={`border-gray-600 text-gray-300 ${social.color} transition-all duration-300 interactive hover:scale-110`}>
                    <social.icon size={20} />
                  </Button>
                ))}
              </div>
            ...
            <Card className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 border-gray-700/50 backdrop-blur-sm animate-slide-in-right">
              <CardContent className="p-8">
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-4">
                    <Input 
                      placeholder="Your Name" 
                      className="bg-gray-700/50 border-gray-600 text-white placeholder-gray-400 focus:border-cyan-400 transition-colors duration-300 interactive"
                    />
                    <Input 
                      type="email" 
                  ...
                  <Textarea 
                    ...
                    rows={5}
                    className="bg-gray-700/50 border-gray-600 text-white placeholder-gray-400 focus:border-cyan-400 transition-colors duration-300 interactive resize-none"
                  />
      ...
      <footer className="bg-black py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="text-3xl font-bold text-white mb-4 interactive">
            ...
            <div className="flex justify-center space-x-6 mb-6">
              {[
                ...
                <a key={index} href="#" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 interactive">
                  <social.icon size={24} />
                </a>
              ))}
            </div>
